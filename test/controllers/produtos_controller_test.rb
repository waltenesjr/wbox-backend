...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { fotoProduto: @produto.fotoProduto, marca_id: @produto.marca_id, nomeProduto: @produto.nomeProduto, usuario_id: @produto.usuario_id }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { fotoProduto: @produto.fotoProduto, marca_id: @produto.marca_id, nomeProduto: @produto.nomeProduto, usuario_id: @produto.usuario_id }
    assert_redirected_to produto_path(assigns(:produto))
  end
